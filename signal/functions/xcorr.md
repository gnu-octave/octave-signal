...
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-xcorr-3"><span class="category-def">Function File: </span><span><code class="def-type">&hellip; =</code> <strong class="def-name">xcorr</strong> <code class="def-code-arguments">( &hellip;, <var class="var">scale</var>)</code></span></dt>
