...
<dt class="deftypefn def-line" id="index-cheby1"><span class="category-def">Function File: </span><span><code class="def-type">[<var class="var">b</var>, <var class="var">a</var>] =</code> <strong class="def-name">cheby1</strong> <code class="def-code-arguments">(<var class="var">n</var>, <var class="var">rp</var>, <var class="var">w</var>)</code><a class="copiable-link" href="#index-cheby1"></a></span></dt>
...
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-cheby1-4"><span class="category-def">Function File: </span><span><code class="def-type">[<var class="var">z</var>, <var class="var">p</var>, <var class="var">g</var>] =</code> <strong class="def-name">cheby1</strong> <code class="def-code-arguments">(&hellip;)</code><a class="copiable-link" href="#index-cheby1-4"></a></span></dt>
...
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-cheby1-6"><span class="category-def">Function File: </span><span><code class="def-type">[&hellip;] =</code> <strong class="def-name">cheby1</strong> <code class="def-code-arguments">(&hellip;, &quot;s&quot;)</code><a class="copiable-link" href="#index-cheby1-6"></a></span></dt>
