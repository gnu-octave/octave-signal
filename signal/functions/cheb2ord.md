...
<dt class="deftypefn def-line" id="index-cheb2ord"><span class="category-def">Function File: </span><span><code class="def-type"><var class="var">n</var> =</code> <strong class="def-name">cheb2ord</strong> <code class="def-code-arguments">(<var class="var">wp</var>, <var class="var">ws</var>, <var class="var">rp</var>, <var class="var">rs</var>)</code></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-cheb2ord-1"><span class="category-def">Function File: </span><span><code class="def-type"><var class="var">n</var> =</code> <strong class="def-name">cheb2ord</strong> <code class="def-code-arguments">([<var class="var">wp1</var>, <var class="var">wp2</var>], [<var class="var">ws1</var>, <var class="var">ws2</var>], <var class="var">rp</var>, <var class="var">rs</var>)</code></span></dt>
...
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-cheb2ord-3"><span class="category-def">Function File: </span><span><code class="def-type">[<var class="var">n</var>, <var class="var">wc_s</var>] =</code> <strong class="def-name">cheb2ord</strong> <code class="def-code-arguments">(&hellip;)</code></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-cheb2ord-4"><span class="category-def">Function File: </span><span><code class="def-type">[<var class="var">n</var>, <var class="var">wc_s</var>, <var class="var">wc_p</var>] =</code> <strong class="def-name">cheb2ord</strong> <code class="def-code-arguments">(&hellip;)</code></span></dt>
