...
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-mscohere-6"><span class="category-def">Function File: </span><span><strong class="def-name">mscohere</strong> <code class="def-code-arguments">(&hellip;)</code></span></dt>
<dd>
