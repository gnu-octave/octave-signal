...
<dt class="deftypefn" id="index-pow2db"><span class="category-def">Function File: </span><span><strong class="def-name">pow2db</strong> <code class="def-code-arguments">(<var class="var">x</var>)</code><a class="copiable-link" href="#index-pow2db"></a></span></dt>
