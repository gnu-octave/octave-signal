...
<dt class="deftypefn def-line" id="index-rceps"><span class="category-def">Function File: </span><span><code class="def-type">[<var class="var">y</var>, <var class="var">ym</var>] =</code> <strong class="def-name">rceps</strong> <code class="def-code-arguments">(<var class="var">x</var>)</code><a class="copiable-link" href="#index-rceps"></a></span></dt>
