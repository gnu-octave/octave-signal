...
<dt class="deftypefn def-line" id="index-tf2zp"><span class="category-def">Function File: </span><span><code class="def-type">[<var class="var">z</var>, <var class="var">p</var>, <var class="var">k</var>] =</code> <strong class="def-name">tf2zp</strong> <code class="def-code-arguments">(<var class="var">num</var>, <var class="var">den</var>)</code><a class="copiable-link" href="#index-tf2zp"></a></span></dt>
